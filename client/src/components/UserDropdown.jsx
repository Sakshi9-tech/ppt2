...
const UserDropdown = () => {
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      >
        <div className="w-8 h-8 rounded-full flex items-center justify-center" style={{ background: 'var(--accent-gold)', color: 'var(--primary-dark)', fontWeight: 700 }}>
        ...
        <div className="dropdown-menu w-72 animate-in slide-in-from-top-2 duration-200" role="menu" aria-label="Account menu">
          ...
          <div className="px-4 py-3">
            <div className="flex items-center space-x-3">
              <div className="w-12 h-12 rounded-full flex items-center justify-center" style={{ background: 'var(--accent-gold)', color: 'var(--primary-dark)', fontWeight: 800 }}>
                <span className="text-sm">{(user?.name || user?.email || 'U').charAt(0).toUpperCase()}</span>
              </div>
